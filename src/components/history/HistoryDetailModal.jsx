          ...
          <div className={styles.leftColumn}>
            ...
            <div className={styles.dataGrid}>
              ...
              <div className={styles.dataItem}>
                ...
                <p className={styles.dataValue}>{decision.Transaction?.type}</p>
              </div>
              <div className={styles.dataItem}>
                <p className={styles.dataLabel}>Country</p>
                <p className={styles.dataValue}>{decision.Transaction?.ip_country}</p>
              </div>
              <div className={styles.dataItem}>
                <p className={styles.dataLabel}>Category</p>
                <p className={styles.dataValue}>{decision.Transaction?.merchant_category}</p>
              </div>
              <div className={styles.dataItem}>
          ...
          <div className={styles.rightColumn}>
            ...
            <div className={styles.verdictCard}>
              ...
              <div className={styles.dataItem}>
                ...
                <p className={styles.dataValue}>{decision.Analyst?.name}</p>
              </div>
              <div className={styles.dataItem}>
